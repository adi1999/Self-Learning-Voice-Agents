...
1. Building voice agent with Pipecat
    - Build a voice bot with Pipecat that communicates with loan defaulters
...
2. **Prompt Rewriting Loop**
    ...
    - Prompt a foundation model (e.g., GPT-5) to suggest a **new version** of the agent by rewriting prompts or logic.
...
Once you’re done, send your submissions to jayanth@riverline.ai
